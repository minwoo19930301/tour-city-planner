...
- 아시아, 유럽, 북미 등 여러 지역의 목적지 템플릿 81개 제공 (일본 7개, 중국 8개 도시 포함)
...
- `assets/heroes/*.jpg`: 도시별 대표 사진. 출처와 라이선스는 [docs/PHOTO_CREDITS.md](docs/PHOTO_CREDITS.md)
- `scripts/fetch_hero.py`: 위키미디어 공용에서 자유 라이선스 사진을 받아 출처를 기록하는 도구
- `scripts/merge_cities.py`, `scripts/new_cities_*.js`: 새 도시 데이터를 `app.js`에 병합하는 도구와 조각 파일
